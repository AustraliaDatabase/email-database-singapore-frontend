  ...
  why: {
    ...
    list: [
      ...
      },
      {
        ...
        description:
          "<p>Our clients can immediately take possession of the database after purchasing the list. We are here to provide you with complete data ownership at no additional cost. Additionally, the customer has unrestricted access to the leads and can download the list from the online dashboard for offline use.</p>",
        contentTitle: "",
        content: ``,
      },
      {
