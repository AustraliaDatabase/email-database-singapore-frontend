...
import Seeds from "../../shared/seeds/realtorOldBy";
  ...
  return (
    <>
      <NextSeo
        ...
        canonical={`${process.env.NEXT_PUBLIC_BASE_URL}/us-email-database-by-state`}
      />
      <PublicLayout>
        ...
        <section>
          <Container>
            <Table
              ...
              data={tableDataSet}
              isProductPage={false}
              type={DATABASE_MAIN_TYPES.COMPANY_DATABASE_OLD}
...
export async function getServerSideProps(context: GetServerSidePropsContext) {
  let response = await instance.post(`/companyProductOld`);
