...
const ALTERNATIVE_FOR_THERS_OBJ = [
  {
    icon: <PresentationChart size={32} />,
    title: "<h3>Why Consider Bookyourdata.com ?</h3>",
    description: `Bookyourdata is one of the leading email listing providers out there. It’s been proven that they provide lists of actual email addresses, not some bot-generated ones. Moreover, generic email addresses like sales@ and contact@ are filtered out of their lists. Many Bookyourdata reviews also asserts that a portion of all the owners behind the contact info they give are responsive.`,
  },
  {
...
export default ALTERNATIVE_FOR_THERS_OBJ;
