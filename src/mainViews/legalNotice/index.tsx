    ...
    <Container className="static-content">
      <Row className="justify-content-center">
        <Col md={10}>
          ...
          <section>
            <h2>Legal</h2>
            <p>EmailDatas owns the intellectual property rights to this website and its content.</p>
          ...
          <section>
            ...
            <p>You are not entitled to use any trademark asset owned by EmailDatas unless you have obtained a license or other permission from EmailDatas following the terms of the agreement. Please get in touch with us if you have any issues with the trademark guidelines contained above.</p>
          </section>
          <section>
            <h2>DISCLAIMER</h2>
            ...
            <p>Every effort is being made to keep the website online and operational. EmailDatas bears responsibility and will not be responsible for any damages from the website being temporarily unavailable due to technical causes beyond our control.</p>
          </section>
        </Col>
      </Row>
    </Container>
