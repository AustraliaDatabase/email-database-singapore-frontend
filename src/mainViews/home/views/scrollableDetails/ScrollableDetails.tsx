    ...
    <Container>
      <Row>
              ...
              return (
                <div className={styles.explain} key={index} id={explain.id}>
                  <h2
                    ...
                    dangerouslySetInnerHTML={{ __html: explain.title }}
                  />
                  <div
                    className={styles.description}
                    dangerouslySetInnerHTML={{ __html: explain.description }}
                  />
                </div>
              );
            })}
        ...
        <Col
          xs={{ order: 1, span: 12 }}
          lg={{ order: 2, span: 3 }}
          className="mb-5 mb-lg-0 d-none d-md-block"
        >
